...
def cefa_main():
    score_list1 = [
        './outputs/B_pro/tta_B_pro_4@3_score.txt',
        ]
    scores = []
    # loading test names
    fid = open('./data/phase2/4_3/dev_test_list.txt', 'r')
    ...
    # fusing
    fout_1 = open('./scores/4_3/4_3.txt', 'w')
    ...
    fout_1.close()
    print('Fianl fused scores: ./scores/4_3/4_3.txt')
