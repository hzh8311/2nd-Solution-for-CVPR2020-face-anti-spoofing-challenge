...
class ResNetDLAS(nn.Module):
    def __init__(self, block, layers, DLAS_type='A', pretrained=None):
    ...
    def _load_pretrained_weights(self, pretrained):
        if pretrained == 'mcs2018':
            weights = torch.load('/media2/a.parkin/codes/Liveness_challenge/models/pretrained/resnet_caffe_mcs_orgl.pth', map_location='cpu')
        elif pretrained == 'afad_lite_g_exp1':
            weights = torch.load('/media2/a.parkin/codes/Liveness_challenge/models/pretrained/resnet_caffe_afad_lite_g_exp1.pth', map_location='cpu')
        elif pretrained == 'afad_lite_g_exp1_mcs2018':
            weights = torch.load('/media2/a.parkin/codes/Liveness_challenge/models/pretrained/resnet_caffe_afad_lite_g_exp1_mcs.pth', map_location='cpu')
        elif pretrained == 'afad_lite_a_exp1_mcs2018':
            weights = torch.load('/media2/a.parkin/codes/Liveness_challenge/models/pretrained/resnet_caffe_afad_lite_a_exp1_mcs.pth', map_location='cpu')
        elif pretrained == 'umdfaces_cce_epoch30':
            weights = torch.load('/media2/a.parkin/codes/Liveness_challenge/models/pretrained/umdfaces_exp1_epoch30.pth', map_location='cpu')
        elif pretrained == 'umdfaces_arc_margin_epoch30':
            weights = torch.load('/media2/a.parkin/codes/Liveness_challenge/models/pretrained/umdfaces_exp2_epoch30.pth', map_location='cpu')
        elif pretrained == 'umdfaces_arc_margin_epoch60':
            weights = torch.load('/media2/a.parkin/codes/Liveness_challenge/models/pretrained/umdfaces_exp2_epoch30.pth', map_location='cpu')
...
def resnetDLAS_B0(pretrained=False, **kwargs):
    """Constructs a ResNet-34 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNetDLAS(BasicBlock, [1, 2, 5, 3], DLAS_type='B0', pretrained=pretrained)
    return model
