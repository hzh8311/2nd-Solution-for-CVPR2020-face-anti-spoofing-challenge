...
def cefa_main():
    score_list1 = [
        './outputs/C/tta_C_4@2_score.txt',
        './outputs/C_seed2/tta_C_seed2_4@2_score.txt',
        './outputs/IR_A/tta_IR_A_4@2_score.txt',
        './outputs/IR_A_seed2/tta_IR_A_seed2_4@2_score.txt',
        './outputs/B0/tta_B0_4@2_score.txt',
        ]
    scores = []
    # loading test names
    fid = open('./data/phase2/4_2/dev_test_list.txt', 'r')
    ...
    # fusing
    fout_1 = open('./scores/4_2/4_2.txt', 'w')
    ...
    fout_1.close()
    print('Fianl fused scores: ./scores/4_2/4_2.txt')
